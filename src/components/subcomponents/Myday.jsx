        ...
        <div className="stories-scroll" ref={container}>
            <ul className="flex-row stories-container">
                ...
                <div className="stories">
                    ...
                    <p><small>Phillips</small></p>
                </div>
                <div className="stories">
                    <div className="flex-column story story-7"></div>
                    <p><small>Salman Khan</small></p>
                </div>
            </ul>
        </div>
